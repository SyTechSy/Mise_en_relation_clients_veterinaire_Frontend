...
@Component({
  selector: 'app-ajouter-sante-photo',
  templateUrl: './ajouter-sante-photo.page.html',
  styleUrls: ['./ajouter-sante-photo.page.scss'],
})
export class AjouterSantePhotoPage implements OnInit {
