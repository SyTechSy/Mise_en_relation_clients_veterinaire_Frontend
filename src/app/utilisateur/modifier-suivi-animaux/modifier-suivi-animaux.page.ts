...
@Component({
  selector: 'app-modifier-suivi-animaux',
  templateUrl: './modifier-suivi-animaux.page.html',
  styleUrls: ['./modifier-suivi-animaux.page.scss'],
})
export class ModifierSuiviAnimauxPage implements OnInit {
